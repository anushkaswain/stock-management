...
<p style="color:blue;">Add a New Stationary Product</p>
...
<button type="button" id="csv"><a href="downloadavailable.php?prefix=SY" target="_blank" style="color:white;text-decoration: none;">Download Table</a></button>
