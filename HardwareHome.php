...
<p style="color:blue;">Add a New Hardware Product</p>
...
<button type="button" id="csv"><a href="downloadavailable.php?prefix=HC" target="_blank" style="color:white;text-decoration: none;">Download Table</a></button>
