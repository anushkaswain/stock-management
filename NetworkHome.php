...
<p style="color:blue;">Add a New Network Product</p>
...
<button type="button" id="csv"><a href="downloadavailable.php?prefix=NW" target="_blank" style="color:white;text-decoration: none;">Download Table</a></button>
