...
<body>
    ...
    <ul>
        ...
        <li style="float: right; background-color:green; margin-right:10px "><a href="dashboard.php" id="STOCK">STOCK</a></li>
</ul>
    </header>
    <nav>
        <ul>
            <li><a href="breakdown_dashboard.php" id="H">Home</a></li>
